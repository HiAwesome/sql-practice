INSERT INTO Music.dbo.Artists(ArtistName, ArtistFrom)
VALUES ('Iron Maiden', '1975-12-25'),
       ('AC/DC', '1973-01-11'),
...
INSERT INTO Music.dbo.Genres (Genre)
VALUES ('Rock'),
       ('Jazz'),
       ('Country'),
       ('Pop'),
...
INSERT INTO Music.dbo.Albums (AlbumName, ReleaseDate, ArtistId, GenreId)
VALUES ('Powerslave', '1984-09-03', 1, 1),
